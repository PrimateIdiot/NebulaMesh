...
<head>
    ...
    <link rel="stylesheet" href="styleMaterials.css">
</head>
...
<body>
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    echo '<div class="image-container">';
                        echo '<img src="' . $row['image_link'] . '" alt="' . $row['material_name'] . '">';
                        echo '<div class="text-container">';
                            echo '<h2>' . $row['material_name'] . '</h2>';
    ...
    <div class="modal-content">
        ...
        <form id="objectForm" action="processOrderForm.php" method="post" onsubmit="return validateForm()">
            <h2 id="materialName" name="materialName"></h2> 
            <br>
            <br>
            <img id="modalImage" src="" alt="Enlarged Image">
            <div class="ratio-box">
                <label for="objectRadio">What model do you prefer for this material?:</label>
                ...
                <input type="hidden" name="material" id="materialInput" value="">
                <br>
    ...
    <script src="scriptMaterials.js"></script>
    <script src="gsapMaterials.js"></script>
</body>
</html>